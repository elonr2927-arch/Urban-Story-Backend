...
const properties = [
  ...
  {
    slug: 'prop-008',
    title: 'Nice 1-Bedroom Apartment with Large Living Room in Chicago',
    type: 'Apartment',
    city: 'Chicago',
    zip: '60644',
    address: 'Near Austin & Chicago Ave, Chicago, IL 60644',
    price: 1200,
    beds: 1,
    baths: 1,
    area: 750,
    description: 'Very nice 1-bedroom apartment featuring a spacious living room, freshly painted interiors, and excellent natural light. This comfortable home offers a great layout perfect for relaxation and everyday living.\n\nConveniently located near Austin and Chicago Avenue with easy access to local amenities, transportation, and neighborhood shops. Available June 1st, 2026. Easy to show.\n\nRequirements: Minimum 620 credit score and proof of income required. Street parking available and central heating included for your comfort.',
    images: [
      'https://i.ibb.co/p6pKLbzQ/6.jpg',
      'https://i.ibb.co/vxhYgHTH/7.jpg',
      'https://i.ibb.co/JWkWDDFw/8.jpg',
      'https://i.ibb.co/mrPQHsJR/9.jpg',
      'https://i.ibb.co/mCS9MrhQ/10.jpg',
      'https://i.ibb.co/wNRq7LdH/11.jpg',
      'https://i.ibb.co/JjxZDx3Y/1.jpg',
      'https://i.ibb.co/tTmzXpcd/2.jpg',
      'https://i.ibb.co/Q3BP560V/3.jpg',
      'https://i.ibb.co/jsk061y/4.jpg',
      'https://i.ibb.co/21nQc8DQ/5.jpg'
    ],
    videoUrl: null,
    amenities: ['Central Heating', 'Street Parking', 'Refrigerator', 'Freshly Painted', 'Spacious Living Room', '1+ Year Lease'],
    available: true,
    ...
    lat: 41.8920,
    lng: -87.7600,
    neighbourhood: 'This vibrant Chicago neighborhood offers convenient access to everyday amenities, public transportation, and local shops. Located near Austin and Chicago Avenue, it provides a practical and well-connected place to call home.',
    createdAt: new Date('2026-05-16')
  },
  {
    slug: 'prop-009',
    title: 'All Bills Paid Studio Apartment in North Miami',
    type: 'Apartment',
    city: 'North Miami',
    zip: '74358',
    address: '200 Pine St, North Miami, OK 74358',
    price: 750,
    beds: 0,
    baths: 1,
    area: 450,
    description: 'Comfortable all bills paid studio apartment available for immediate move-in. This well-maintained unit offers a functional layout perfect for individuals seeking simplicity and convenience. Enjoy the ease of month-to-month leasing with all utilities included.\n\nA $600 security deposit is required. No pets allowed. Located in a quiet area of North Miami, this studio provides great value with minimal monthly expenses.',
    images: [
      'https://i.ibb.co/9HKLcmxy/1.jpg',
      'https://i.ibb.co/KxpxXzJT/2.jpg',
      'https://i.ibb.co/CKd9Qj8W/3.jpg',
      'https://i.ibb.co/Tx5Lp9Dp/4.jpg'
    ],
    videoUrl: null,
    amenities: ['All Bills Paid', 'Month-to-Month Lease', 'Utilities Included'],
    available: true,
    availableFrom: '2026-05-25',
    rating: 4.4,
    reviewCount: 9,
    ...
    lat: 36.9100,
    lng: -94.8830,
    neighbourhood: 'North Miami, Oklahoma is a small, peaceful community offering affordable living with a friendly atmosphere. This location provides a quiet residential setting while remaining conveniently situated near local amenities.',
    createdAt: new Date('2026-05-16')
  },
  {
    slug: 'prop-010',
    ...
    images: [
      ...
      'https://i.ibb.co/zVL2srTp/1.jpg',
      'https://i.ibb.co/BHZCCpH6/2.jpg',
      'https://i.ibb.co/N6VMpH8m/3.jpg',
      'https://i.ibb.co/JWfVv7nx/4.jpg',
      'https://i.ibb.co/VnrrQQD/5.jpg',
      'https://i.ibb.co/jPXfdsVR/6.jpg',
      'https://i.ibb.co/0p366DSc/7.jpg'
    ],
    videoUrl: null,
    amenities: ['Newly Renovated', 'Quartz Countertops', 'Stainless Steel Appliances', 'Hardwood-Style Flooring', 'Mini-Split AC & Heating', 'Onsite Laundry', 'Pet Friendly', 'Water & Sewer Included', 'Lawncare Included'],
    available: true,
    availableFrom: '2026-06-01',
    rating: 4.8,
    reviewCount: 11,
